    ...
    <>
      ...
      <div
        style={{
          ...
          opacity: isVisible ? 1 : 0,
          transform: isVisible ? 'translate(-50%, -50%)' : 'translate(-50%, -48%)',
...
function CannotDeleteState({
  ...
  return (
    <div>
      ...
      >
        Thông tin này hiện đang có dữ liệu liên kết trong hệ thống và không thể xóa bỏ để đảm bảo tính chính xác của dữ liệu.
      </p>
        ...
        >
          {dependencies.map((dep, idx) => (
            ...
            >
              ...
              <span style={{ fontWeight: '500' }}>{dep.tableName}:</span> {dep.count} bản ghi
            </li>
          ))}
        </ul>
      </div>
      ...
      <div style={{ display: 'flex', gap: '12px', justifyContent: 'flex-end' }}>
        <button
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 4px 12px rgba(240, 97, 146, 0.3)'
          }}
          onMouseLeave={(e) => {
...
function ConfirmDeleteState({
  ...
  return (
    <div>
      ...
      >
        Bạn có chắc chắn muốn xóa <span style={{ fontWeight: '600', color: '#2B3674' }}>{itemName}</span> này không? Hành động này không thể hoàn tác.
      </p>
