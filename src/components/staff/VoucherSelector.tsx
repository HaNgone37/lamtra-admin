    ...
    switch (e.key) {
      case "ArrowDown":
        ...
        setSelectedIndex((prev) =>
          Math.min(prev + 1, filteredVouchers.length - 1),
        );
        break;
      case "ArrowUp":
        e.preventDefault();
    ...
    <div style={{ marginBottom: "20px" }}>
      ...
      <div style={{ position: "relative" }} ref={dropdownRef}>
        ...
        <input
          ...
          type="text"
          placeholder={
            appliedVoucher ? appliedVoucher.code : "Chọn hoặc nhập mã ưu đãi"
          }
          value={searchText}
              ...
              filteredVouchers.map((voucher, idx) => (
                <button
                  ...
                  style={{
                    ...
                    border: "none",
                    backgroundColor:
                      selectedIndex === idx ? PINK_VERY_LIGHT : "#FFFFFF",
                    color: TEXT_NAVY,
                    textAlign: "left",
                    cursor: "pointer",
                    fontSize: "13px",
                ...
                >
                  <span style={{ flex: 1 }}>{formatVoucherText(voucher)}</span>
      ...
      {appliedVoucher && (
        ...
        >
          ✓ Đã áp dụng mã{" "}
          <span style={{ fontWeight: "700" }}>{appliedVoucher.code}</span>: giảm{" "}
