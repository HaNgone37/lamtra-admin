...
export const VouchersDistributionTab: React.FC<
  VouchersDistributionTabProps
> = ({
  customers,
  selectedCustomers,
  selectedVoucher,
    ...
    >
      ...
      >
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) =>
              onVoucherChange(e.target.value ? parseInt(e.target.value) : null)
            }
            style={{
              width: "100%",
              padding: "8px 12px",
          ...
          {selectedVoucher && (
            ...
            >
              ...
              >
                Hạn dùng đến:{" "}
                {voucherService.formatVoucherExpiry(
                  stats.find((s) => s.voucherid === selectedVoucher)
                    ?.expirydate || "",
                )}
              </p>
            </div>
      ...
      <div>
                ...
                style={{
                  ...
                  backgroundColor:
                    selectedReason === reason.value
                      ...
                      : COLORS.card,
                  color:
                    selectedReason === reason.value ? COLORS.card : COLORS.text,
                  fontSize: "13px",
                  fontWeight: "500",
                  cursor: "pointer",
        ...
        {selectedVoucher && selectedCustomers.size > 0 && (
          ...
          >
            {(() => {
              const voucher = stats.find(
                (s) => s.voucherid === selectedVoucher,
              );
              ...
              if (voucher.discounttype === "%") {
                ...
                const estimatedOrderValue =
                  (voucher as VoucherStatistic & { minOrderValue?: number })
                ...
                totalEstimatedValue = selectedCustomers.size * discountValue;
              }
              ...
              return (
                ...
                >
                  <p style={{ margin: "0 0 8px 0" }}>
                    📋 <strong>Bạn chuẩn bị tặng:</strong>{" "}
                  ...
                  <p style={{ margin: 0 }}>
                    ...
                    <strong>
                      ...
                      {totalEstimatedValue.toLocaleString()}đ
                    </strong>
                  </p>
                </div>
              );
        ...
        >
                ...
                <tbody>
                  {customers.map((customer) => (
                    <tr
                      ...
                      style={{
                        borderBottom: `1px solid ${COLORS.border}`,
                        backgroundColor: selectedCustomers.has(
                    ...
                    >
                      <td style={{ padding: "12px 16px", textAlign: "center" }}>
                        <input
                          ...
                          onChange={() =>
                            onCustomerToggle(Number(customer.customerid))
                          }
                          style={{ cursor: "pointer" }}
                        />
                      </td>
          ...
          >
            <button
              onClick={onIssue}
              disabled={
                isIssuing || selectedCustomers.size === 0 || !selectedVoucher
              }
              style={{
                padding: "10px 24px",
                fontSize: "14px",
            ...
            >
              {isIssuing
                ? "Đang gửi..."
                : `Phát Hành (${selectedCustomers.size})`}
            </button>
          </div>
        </div>
      </div>
